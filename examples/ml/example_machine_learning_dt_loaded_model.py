...
File name: example_machine_learning_dt_loaded_model.py
    Example code for the trading technical indicators library, Machine Learning
    features (Load trained DT model).
"""
...
loaded_model.mlLoadModel(file_name='./data/dt_trained_model_SCMN_SW.dmp')

# Get loaded model details
print('\nLoaded DT model details:', loaded_model.mlModelDetails())
