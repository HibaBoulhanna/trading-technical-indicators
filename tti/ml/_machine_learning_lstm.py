...
File name: _machine_learning_lstm.py
    Implements a Long Short Term Memory Neural Network for the Machine Learning
...
class MachineLearningLSTM(MachineLearningAPI):
    """
    Machine Learning LSTM class implementation.
    """
    ...
    def mlTrainModel(self, input_data, ti_features=DEFAULT_TI_FEATURES,
        ...
        """
        Trains a LSTM machine learning model for prices direction predictions.
